...
# %%
def profile_main(onnx_path="", onnx_model=None, WORK_DIR="./tune_kernels/",
                 DB_WIPE=True, USE_GE_BENCHMARK=True, BENCHMARK_NUM_RUNS= 1, E2E=False,
...
if __name__=="__main__":
    ...
    profile_results = profile_main(onnx_path=onnx_path, DB_WIPE=False, USE_GE_BENCHMARK=False, BENCHMARK_NUM_RUNS= 50, E2E=True)
