...
void cudaMaxPooling(int padding, int c, int i_h, int i_w, int fw, int fh)
{   
...
void cudaMaxPooling_Ref(int c, int h, int w, int fw, int fh)
{
...
int main(int argc, char *argv[])
{
    ...
    cudaMaxPooling(padding, C, H, W, FW, FH);
